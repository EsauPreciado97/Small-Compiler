# LUIS ESAÚ PRECIADO MARTINEZ - A01631211
...
def p_error(p):
    ...
    if VERBOSE:
        if p is not None:
            print ("An error was found on line:" + str(p.lexer.lineno)+"  Context Error " + str(p.value))
        else:
            print ("Lexical error found on line: " + str(c_lexer.lexer.lineno))
    else:
...
if __name__ == '__main__':
    ...
    if (len(sys.argv) > 1):
        ...
        print("USAGE: small_compiler.py <path to file>")
        exit()
